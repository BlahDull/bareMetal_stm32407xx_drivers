...
#define OTG_HS_DAINTMSK ((uint32_t*)(USB_OTG_HS_BASE_ADDR + 0x81CU))
#define OTG_HS_GRXFSIZ  ((uint32_t*)(USB_OTG_HS_BASE_ADDR + 0x024U))
#define OTG_HS_TX0FSIZ  ((uint32_t*)(USB_OTG_HS_BASE_ADDR + 0x028U))
...
#define ENDPOINT_TYPE_BULK 0b10U
#define ENDPOINT_TYPE_INTERRUPT 0b11U
#define ENDPOINT_TYPE_ISOCHRONOUS 0b01U
#define ENDPOINT_TYPE_CONTROL 0b00U
